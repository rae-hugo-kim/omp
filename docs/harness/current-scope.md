...
## Acceptance Criteria
- [ ] AC1-adr-landed — ADR 002와 영속 사이클 큐(seed + current-scope)가 첫 커밋으로 착지한다
- [ ] AC2-sync-prefix-glob — harness-sync.sh가 .omp/rules/harness-*.md 접두사 글롭 항목을 소비자 파일 비접촉으로 동기화한다
